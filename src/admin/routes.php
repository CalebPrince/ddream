...
return [
    ...
    'GET /blog'              => ['blog', 'index'],
    'GET /blog/new'          => ['blog', 'create'],
    'POST /blog'             => ['blog', 'store'],
    'GET /blog/{id}'         => ['blog', 'edit'],
    'POST /blog/{id}'        => ['blog', 'update'],
    'GET /careers'       => ['catalog', 'careers_index'],
    'GET /careers/new'   => ['catalog', 'careers_create'],
    'POST /careers'      => ['catalog', 'careers_store'],
    'GET /careers/{id}'  => ['catalog', 'careers_edit'],
    'POST /careers/{id}' => ['catalog', 'careers_update'],
    'GET /services'       => ['catalog', 'services_index'],
    'GET /services/new'   => ['catalog', 'services_create'],
    'POST /services'      => ['catalog', 'services_store'],
    'GET /services/{id}'  => ['catalog', 'services_edit'],
    'POST /services/{id}' => ['catalog', 'services_update'],
